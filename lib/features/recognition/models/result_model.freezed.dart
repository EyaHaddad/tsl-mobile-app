...
mixin _$RecognitionResultData {
  ...
  String get primaryGestureAr =>
      throw _privateConstructorUsedError; // Arabic name for the primary gesture
...
abstract class $RecognitionResultDataCopyWith<$Res> {
  factory $RecognitionResultDataCopyWith(RecognitionResultData value,
...
/// @nodoc
class _$RecognitionResultDataCopyWithImpl<$Res,
...
class __$$RecognitionResultDataImplCopyWithImpl<$Res>
    extends _$RecognitionResultDataCopyWithImpl<$Res,
        _$RecognitionResultDataImpl>
    implements _$$RecognitionResultDataImplCopyWith<$Res> {
  __$$RecognitionResultDataImplCopyWithImpl(_$RecognitionResultDataImpl _value,
  ...
  $Res call({
    ...
    return _then(_$RecognitionResultDataImpl(
      primaryGesture: null == primaryGesture
          ? _value.primaryGesture
          : primaryGesture // ignore: cast_nullable_to_non_nullable
              as String,
...
// Arabic name for the primary gesture
  @override
...
// number of frames
  ...
  _$$RecognitionResultDataImplCopyWith<_$RecognitionResultDataImpl>
      get copyWith => __$$RecognitionResultDataImplCopyWithImpl<
          _$RecognitionResultDataImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RecognitionResultDataImplToJson(
      this,
    );
  }
}
...
abstract class _RecognitionResultData implements RecognitionResultData {
  const factory _RecognitionResultData(
      ...
      final int processingTime,
      final int sequenceLength,
      final String debug}) = _$RecognitionResultDataImpl;
  ...
  @override
  String get primaryGestureAr;
  @override // Arabic name for the primary gesture
...
abstract class $AlternativeMatchCopyWith<$Res> {
  factory $AlternativeMatchCopyWith(
          AlternativeMatch value, $Res Function(AlternativeMatch) then) =
...
abstract class _$$AlternativeMatchImplCopyWith<$Res>
    implements $AlternativeMatchCopyWith<$Res> {
  factory _$$AlternativeMatchImplCopyWith(_$AlternativeMatchImpl value,
...
class __$$AlternativeMatchImplCopyWithImpl<$Res>
  ...
  __$$AlternativeMatchImplCopyWithImpl(_$AlternativeMatchImpl _value,
  ...
  $Res call({
    ...
    return _then(_$AlternativeMatchImpl(
      gesture: null == gesture
          ? _value.gesture
          : gesture // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$AlternativeMatchImpl implements _AlternativeMatch {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$AlternativeMatchImplToJson(
      this,
    );
  }
}
...
abstract class _AlternativeMatch implements AlternativeMatch {
  const factory _AlternativeMatch(
      ...
      required final double confidence}) = _$AlternativeMatchImpl;

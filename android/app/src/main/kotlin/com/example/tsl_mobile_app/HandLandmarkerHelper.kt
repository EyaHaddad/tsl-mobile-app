...
class HandLandmarkerHelper(
    // Defaults aligned with the current LSTM data pipeline.
    ...
    fun detectImage(image: Bitmap): ResultBundle? {
        ...
        // Ensure sRGB-compatible bitmap before converting to MPImage.
        val rgbBitmap =
            if (image.config == Bitmap.Config.ARGB_8888) image
    ...
    companion object {
        ...
        // Low thresholds to keep detection permissive during data capture.
        ...
        // Two hands are needed to build 126 features per frame.
